...
<!-- workspace-kit-source: .workspace-kit/packages/skills/spec.SKILL.md -->
...
For Fabro-backed stage prompts, align prompt structure with
...
When the ticket runs through Fabro, ensure `spec.md` is compatible with
`.workspace-kit/templates/fabro/prompts/spec.md` expectations (explicit pass line, scoped refs).
