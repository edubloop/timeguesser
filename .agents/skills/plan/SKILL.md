...
<!-- workspace-kit-source: .workspace-kit/packages/skills/plan.SKILL.md -->
...
When used with Fabro, keep output compatible with
`.workspace-kit/templates/fabro/prompts/plan.md` and the prompt-hardening contract in
